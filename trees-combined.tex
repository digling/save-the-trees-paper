...
investigation and into the processes of external language change in general.\footnote{
We follow \citet{Gabelentz1891} in distinguishing \emph{external} (\emph{äußere}) from
\emph{internal} (\emph{innere}) language history, the former pointing to the development of the
languages in one language family, the latter to the development of one and the same language in
different stages.}  
