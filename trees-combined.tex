...
\textcolor{red}{talk quickly about Bayesian or whatever methods and contrast them from cladistics,
thereby showing that the new methods offer some advantages, but also face challenges, this does not
need to be long, but it should summarize the main ideas of cladistics, that is, the classical
