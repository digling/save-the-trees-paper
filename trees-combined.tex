...
\Comment{This needs to be moved to other places in the text, as it certainly does not present, but
bring up arguments against glottometrie.}
Three general problems of the method of historical glottometry can be mentioned in this context: 
%(1)
%the lack of a true phylogenetic analysis, (2) the problematic notion of the diffusion of shared
%innovations, and (3) the agnostic character of glottometry regarding the modeling of shared
%traits. (1) 
...
%In the following three sections of this paper, we will further substantiate these claims by pointing
%to the theoretical and practical necessity of the tree model, its specific advantages, and by a
%detailed account on how tree-like aspects of language change may be masked by 
