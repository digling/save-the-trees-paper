...
\subsection{Inherited Variation}
...
accept it for the sake of argument.} overlapping isoglosses constitute in his view a major problem
for the tree model. Regardless of whether lexically-specific sound changes have more difficulty to
